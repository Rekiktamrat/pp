    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-8 text-gray-600">
          Send manual or automatic notifications to users.
        </p>
        ...
        {(isLoading || isSuccess || isError) && (
          <div className="mb-4">
            ...
            {isSuccess && (
              <div className="text-green-500">Notification sent!</div>
            )}
                ...
                {Object.keys(typeColors).map((t) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded capitalize ${
                      type === t ? typeColors[t] : "bg-gray-100 text-gray-700"
                    }`}
                    onClick={() => setType(t)}
                  >
                    {t}
        ...
        {tab === "automatic" && (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              <button
                className="w-full flex items-center justify-between p-3 border rounded-lg hover:bg-green-50"
                onClick={() => handleQuickAuto("welcome")}
                disabled={isLoading}
              >
              ...
              <button
                className="w-full flex items-center justify-between p-3 border rounded-lg hover:bg-yellow-50"
                onClick={() => handleQuickAuto("inactive")}
                disabled={isLoading}
              >
                <span>Notify Inactive</span>
                <span>💤</span>
              </button>
              <button
                className="w-full flex items-center justify-between p-3 border rounded-lg hover:bg-blue-50"
                onClick={() => handleQuickAuto("promotion")}
                disabled={isLoading}
              >
                <span>Promotion</span>
                <span>🎉</span>
